...
public class RemoveMinorityScriptsTextFilterTest {
    ...
    @Test
    public void testWithCyrillicAndHani() {
        RemoveMinorityScriptsTextFilter filter = RemoveMinorityScriptsTextFilter.forThreshold(0.35f);
    ...
    @Test
    public void testWithChineseAndSomeEnglish() {
        ...
        RemoveMinorityScriptsTextFilter filter = RemoveMinorityScriptsTextFilter.forThreshold(0.42f);
        assertEquals(filter.filter(input), input);

        //expect the English to be removed
        filter = RemoveMinorityScriptsTextFilter.forThreshold(0.43f);
     ...
     */
    @Test
    public void testJustLatin() {
        RemoveMinorityScriptsTextFilter filter = RemoveMinorityScriptsTextFilter.forThreshold(0.01f);
